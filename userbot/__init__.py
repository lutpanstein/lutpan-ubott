...
# Default .alive logo
ALIVE_LOGO = (
    os.environ.get("ALIVE_LOGO") or "https://telegra.ph/file/ad02750e78083a8c57e90.jpg"
)

INLINE_PIC = (
    os.environ.get("INLINE_PIC") or "https://telegra.ph/file/97b753a248f764d72d47c.jpg"
)

# Picture For VCPLUGIN
PLAY_PIC = (
    os.environ.get("PLAY_PIC") or "https://telegra.ph/file/ad02750e78083a8c57e90.png"
)

QUEUE_PIC = (
    os.environ.get("QUEUE_PIC") or "https://telegra.ph/file/ad02750e78083a8c57e90.png"
)
...
async def update_restart_msg(chat_id, msg_id):
    message = (
        f"𝙻𝚄𝚃𝙿𝙰𝙽 𝚄𝚂𝙴𝚁𝙱𝙾𝚃 v{BOT_VER} NYALA\n\n"
    ...
    try:
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith("@SharingUserbot"):
                ...
                result = builder.photo(
                    file=logoman,
                    link_preview=False,
                    text=f"⚝ 𝙻𝚄𝚃𝙿𝙰𝙽 𝚄𝚂𝙴𝚁𝙱𝙾𝚃 ⚝\n\n⚘ 𝙾𝚆𝙽𝙴𝚁 [{user.first_name}](tg://user?id={user.id})\n⚘ 𝙿𝙻𝚄𝙶𝙸𝙽`{len(dugmeler)}`",
                    buttons=buttons,
                )
            elif query.startswith("repo"):
                result = builder.article(
                    title="ʟᴜᴛᴘᴀɴꜱᴛᴇɪɴ",
                    description="𝚁𝙴𝙿𝙾 𝙻𝚄𝚃𝙿𝙰𝙽 𝚄𝚂𝙴𝚁𝙱𝙾𝚃",
                    url="https://t.me/lutpansupport",
                    thumb=InputWebDocument(INLINE_PIC, 0, "image/jpeg", []),
                    text="𝙻𝚄𝚃𝙿𝙰𝙽 𝚄𝚂𝙴𝚁𝙱𝙾𝚃\n➖➖➖➖➖➖➖➖➖➖\n✣ **Owner Repo :** [ʟᴜᴛᴘᴀɴꜱᴛᴇɪɴ](https://t.me/Lutpanstein\n✣ **Support :** @lutpansupport\n✣ **Repository :** [𝙻𝚄𝚃𝙿𝙰𝙽 𝚄𝚂𝙴𝚁𝙱𝙾𝚃](https://github.com/lutpanstein/lutpan-ubott)\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url("ɢʀᴏᴜᴘ", "https://t.me/SharingUserbot"),
                            custom.Button.url(
                                "ʀᴇᴘᴏ", "https://github.com/lutpanstein/lutpan-ubott"
                            ),
                        ],
                    ],
                    link_preview=False,
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid or event.query.user_id in SUDO_USERS:
                ...
                text = f"⚝ 𝙻𝚄𝚃𝙿𝙰𝙽 𝚄𝚂𝙴𝚁𝙱𝙾𝚃 𝙸𝙽𝙻𝙸𝙽𝙴 𝙼𝙴𝙽𝚄 ⚝\n\n⚘ 𝙾𝚆𝙽𝙴𝚁 [{user.first_name}](tg://user?id={user.id})\n⚘ 𝙿𝙻𝚄𝙶𝙸𝙽 `{len(dugmeler)}` "
                await event.edit(
                    text,
                    file=logoman,
                    buttons=buttons,
                ...
                reply_pop_up_alert = f"MAU NGAPAIN KONTOL INI PUNYA {owner}"
