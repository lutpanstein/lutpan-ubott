...
async def autopilot():
    LOGS.info("WAITTTT KONTOOOLLL LAGII DIBIKINNINNN GRUB LOGNYA AJJGGG")
    desc = "NI GRUB BUAT NGELIAT LOG ⚝ 𝙻𝚄𝚃𝙿𝙰𝙽 𝚄𝚂𝙴𝚁𝙱𝙾𝚃 ⚝.\n\nHARAP JANGAN OTTT DARI SINI YA KONTOOLLLL.\n\n⚘ Powered By ~ @Lutpanstein ⚘"
    try:
        grup = await bot(
